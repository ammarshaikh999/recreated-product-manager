...
- Fixed StreamlitDuplicateElementId caused by reusing the same URL/file uploader widgets in both tabs.
- Scanner now checks WooCommerce REST API product content AND the live public product page.
- This helps when Product Specifications are rendered by Elementor/theme/custom frontend markup.
- Scanner reports "Found" when the phrase is visible on the live product page.
